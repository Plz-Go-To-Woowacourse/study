...
public enum ErrorMessage {
    ...
    INVALID_LOTTO_COUNT(String.format("%s개의 번호를 입력해 주세요.", LottoRule.LOTTO_NUMBER_COUNT.getValue())),
    INVALID_BONUS_NUMBER("보너스 번호는 당첨 번호와 중복될 수 없습니다."),
    INVALID_LOTTO_NUMBER(String.format("로또 번호는 %d~%d 사이의 숫자만 가능 합니다.",
            LottoRule.START_LOTTO_NUMBER.getValue(), LottoRule.END_LOTTO_NUMBER.getValue()))
    ;
